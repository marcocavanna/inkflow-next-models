 ...
 */
interface MongoDBAggregationComparisonOperators<Reference = [ string | number | MongoDBAggregationExpressions, string | number | MongoDBAggregationExpressions ]> {
...
interface MongoDBAggregationStages<Results extends AnyObject = AnyObject> {
  ...
  $match: Partial<MongoDBAggregationBooleanOperators>
    ...
    | { [key: string]: string | number | boolean | RegExp | mongoose.Types.ObjectId | Partial<MongoDBAggregationComparisonOperators<number>> };
